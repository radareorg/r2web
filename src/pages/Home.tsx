...
export default function Home() {
    ...
    const [selectedVersion, setSelectedVersion] = useState("6.1.2");
        ...
        const fetchR2Versions = async () => {
            try {
                ...
                const versions = data
                    ...
                    .filter((version: { value: string; }) => version.value !== "6.1.2" && /^\d+\.\d+\.\d+$/.test(version.value))
